...
const Checkout = () => {
    ...
    <div className="form-group">
        ...
        <input type="text" className="form-control"  placeholder="Ingrese nombre y apellido"/>
    </div>
    <div className="form-group">
    ...
    <div className="form-group">
        ...
        <input type="number" className="form-control"  placeholder="Ingrese DNI"/>
    </div>
    <div className="form-group">
        <label htmlFor="telefono" className="form-label mt-4">Número telefónico</label>
        <input type="number" className="form-control"  placeholder="Ingrese número telefónico" />
    </div>
    <div className="form-group">
